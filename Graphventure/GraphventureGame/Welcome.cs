...
namespace Graphventure.GraphventureGame {
    ...
    public class Welcome : Screen {
        ...
        public override void Draw(SpriteBatch spriteBatch, GameTime gameTime) {
            ...
            var line1 = "Welcome to Graphventure";
            var line2 = "Hit return to start";
            {
            ...
            {
                var fontorigin = Fonts.Welcome.MeasureString(line2);
                var fontpos = new Vector2(graphicsdevice.Viewport.Width / 2, graphicsdevice.Viewport.Height / 2);
                fontpos.X = fontpos.X + (fontorigin.X / 2);
                fontpos.Y = fontpos.Y + fontorigin.Y;
                spriteBatch.DrawString(Fonts.Welcome, line2, fontpos, Color.Black, 0, fontorigin, 1.0f, SpriteEffects.None, 0.5f);
            }
        }
        ...
        public override void Update(GameTime gameTime) {
            ...
            if (keyboardState.IsKeyDown(Keys.Enter)) {
                Graphventure.CurrentAdventure.Start();
            }
        }
    }
}